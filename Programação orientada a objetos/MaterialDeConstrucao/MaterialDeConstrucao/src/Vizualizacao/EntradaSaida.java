...
public class EntradaSaida {
	...
	public static String exibirProdutosCadastrados(String listaCadastrados) {
		JOptionPane.showMessageDialog(null, listaCadastrados, "Todos os produtos cadastrados",
	...
	public static String exibirTodosCupons(String listaTodosCupons) {
		JOptionPane.showMessageDialog(null, listaTodosCupons, "Todos os cupons de venda",
				JOptionPane.INFORMATION_MESSAGE);
